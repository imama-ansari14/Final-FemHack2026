...
// This file only ever runs on the server (inside app/api routes), so the
// API key never reaches the browser. NEVER import this file from a
 ...
 * Always returns a safe, validated object - even if the AI call fails,
